...
class Reorder extends Component {
  ...
  render() {
    console.log(`In Reorder: ${this.props.practical.teacher}`)
    console.log(`In Reorder: ${this.props.practical.room}`)
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      value={this.props.practical.teacher}
                    />
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      name="room"
                      onChange={this.logChange}
                      value={this.props.practical.room}
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input
                      ...
                      name="dateReq"
                      onChange={this.logChange}
                      value={this.props.practical.datereq}
